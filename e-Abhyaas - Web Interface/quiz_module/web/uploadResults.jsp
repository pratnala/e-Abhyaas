<%--
The invigilator uploads the CSV of answers given by the student with the student's mac address on this page
--%>
...
<div id="main_container">
            ...
            <ul>
               ...
               <li><a href="seatingArrangement.jsp">Seating Arrangement</a></li>
                ...
                <li><a href="uploadResults.jsp"  class="current">Result</a></li>
            </ul>
        </div>
            </div>
            ...
            <div id="main_content">
              ...
              <div id="main_middle_column">
                  ...
                  <h1>Upload Results in CSV format:</h1>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <form action="resultsUpload.jsp" method="post" name="form1" id="form1"  enctype="multipart/form-data">
                    <p class="button">
                      <input name="file" type="file" class="textfield" id="file"  style="font-family:'Times New Roman', Times, serif " size="50" accept="application/msexcel"/>
                        </p>
