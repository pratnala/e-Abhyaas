...
<div id="main_container">
            ...
            <div id="main_content">
              ...
              <div id="main_middle_column">
                  ...
                  <h1>Upload Photographs of Students (with name as their MacIds in ZIP format):</h1>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <form action="picsUpload.jsp" method="post" name="form1" id="form1"  enctype="multipart/form-data">
                    <p class="button">
