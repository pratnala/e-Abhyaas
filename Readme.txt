...
2. The 7 files are:
	...
	g. Readme.txt
3. "e-Abhyaas - Web Interface.zip" should be unzipped and opened with NetBeans. This is the web interface for the teacher to upload questions and for the invigilator to download the various files
4. "e-Abhyaas - Invigilator interface on laptop.zip" should be unzipped and opened with NetBeans. This is the interface for the invigilator's laptop during conduct of the examination.
5. "e-Abhyaas - Student interface on Aakash tablet.rar" should be unzipped and opened with Eclipse. This is the app for the Aakash tablet.
